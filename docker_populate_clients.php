...
// Skrypt do uruchomienia z poziomu kontenera Docker
...
// Używamy zmiennych środowiskowych z kontenera Docker
$databaseUrl = getenv('DATABASE_URL') ?: 'pgsql://symfony:symfony@db:5432/symfony';

try {
    $connection = \Doctrine\DBAL\DriverManager::getConnection(['url' => $databaseUrl]);
    $entityManager = EntityManager::create($connection, $config);

    echo "Rozpoczynam napełnianie tabel Client i ClientAddress...\n";

    // Dane testowe dla klientów (skrócone dla przykładu)
    $clientsData = [
        [
    ...
    echo "Sprawdź czy kontenery Docker są uruchomione i baza danych dostępna.\n";
}
